...
dtl_app_get_alpha_t(n, N, delta, q_seq, gamma_seq, alpha, fix_rho = NULL)$rst_alpha_t[1,]
dtl_app_get_alpha_t(n, N, delta, q_seq, gamma_seq, alpha, fix_rho = 1)$rst_alpha_t[1,]
